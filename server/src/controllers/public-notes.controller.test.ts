...
describe('Public Notes Controller', () => {
  ...
  describe('Not signed in (anonymous access)', () => {
    ...
    it('should create a new public note anonymously', async () => {
      ...
      expect(response.data).toHaveProperty('content', 'This is a new public note')
      ...
      const noteExists = getAllResponse.data.some((note: any) => note.id === noteId)
    ...
    it('should create a public note with custom title when provided', async () => {
      ...
      expect(response.data).toHaveProperty('content', 'Public note with custom title')
      expect(response.data).toHaveProperty('isPublic', 'true')
    })
    ...
    it('should delete a public note', async () => {
      ...
      const createResponse = await client.api['public-notes'].post(noteData)
