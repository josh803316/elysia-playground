      ...
      app
                    ...
                    .put(
                      ...
                      async (ctx: any) => {
                        try {
                          ...
                          const result = await this.notesModel.update(typedCtx.db, Number(id), updatedNote);
                          if (!result) {
        ...
        .post(
          ...
          async (ctx: any) => {
            try {
              ...
              const contentRegex =
                typeof typedCtx.body?.contentRegex === 'string' ? typedCtx.body.contentRegex.trim() : '';
        ...
        .delete('/notes/:id/admin', async (ctx: any) => {
          try {
            ...
            console.log('typeof ctx.request.headers.get:', typeof typedCtx.request.headers.get);
