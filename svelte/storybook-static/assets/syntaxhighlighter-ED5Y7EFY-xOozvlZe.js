import {
  ...
  S as xt,
  b as vt,
} from './DocsRenderer-LL677BLK-DtpHh83m.js';
import {bo as Z, bm as F} from './iframe-3AYY9gF4.js';
...
var At = F({
      ...
      function t(a) {
        (function (n) {
          var o =
            ...
            u = {pattern: /(^(["']?)\w+\2)[ \t]+\S.*/, lookbehind: !0, alias: 'punctuation', inside: null},
            d = {
              bash: u,
          ...
          ((n.languages.bash = {
            ...
            'assign-left': {
              pattern: /(^|[\s;|&]|[<>]\()\w+(?=\+?=)/,
              inside: {environment: {pattern: RegExp('(^|[\\s;|&]|[<>]\\()' + o), lookbehind: !0, alias: 'constant'}},
              alias: 'variable',
              lookbehind: !0,
            },
            string: [
    ...
    '../../node_modules/refractor/lang/js-extras.js'(e, r) {
      ...
      function t(a) {
        (function (n) {
          ...
          for (
            var u = ['function', 'function-variable', 'method', 'method-variable', 'property-access'], d = 0;
            d < u.length;
            d++
          ) {
            var l = u[d],
                  ...
                  (typeof S != 'string' &&
                    (S.type === 'tag' && S.content[0] && S.content[0].type === 'tag'
                      ? S.content[0].content[0].content === '</'
                        ? b.length > 0 && b[b.length - 1].tagName === h(S.content[0].content[1]) && b.pop()
              ...
              table: {
                ...
                inside: {
                  'table-data-rows': {
                    ...
                    lookbehind: !0,
                    inside: {'table-data': {pattern: RegExp(d), inside: n.languages.markdown}, punctuation: /\|/},
                  },
                  'table-line': {
                    pattern: RegExp('^(' + l + ')' + f + '$'),
                    lookbehind: !0,
                  ...
                  'table-header-row': {
                    pattern: RegExp('^' + l + '$'),
                    inside: {
                      'table-header': {pattern: RegExp(d), alias: 'important', inside: n.languages.markdown},
                      punctuation: /\|/,
                    },
                  },
                },
            ...
            return (
              (S = S.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function (E, _) {
                if (((_ = _.toLowerCase()), _[0] === '#')) {
                  var A;
                  return (_[1] === 'x' ? (A = parseInt(_.slice(2), 16)) : (A = Number(_.slice(1))), x(A));
                } else {
                  var i = C[_];
                  return i || E;
                }
      ...
      function n(o) {
        (o.register(t),
          ...
          (function (u) {
            ...
            ((l.pattern = RegExp(/(^|[^\w$]|(?=<\/))/.source + '(?:' + l.pattern.source + ')', l.pattern.flags)),
              (l.lookbehind = !0));
          })(o));
      }
    },
    ...
    '../../node_modules/refractor/lang/yaml.js'(e, r) {
      ...
      function t(a) {
        (function (n) {
          var o = /[*&][^\s[\]{},]+/,
            u = /!(?:<[\w\-%#;/?:@&=+$,.!~*'()[\]]+>|(?:[a-zA-Z\d-]*!)?[\w\-%#;/?:@&=+$.~*'()]+)?/,
            d = '(?:' + u.source + '(?:[ 	]+' + o.source + ')?|' + o.source + '(?:[ 	]+' + u.source + ')?)',
            l =
  ...
  rt = F({
    '../../node_modules/hastscript/node_modules/property-information/lib/util/defined-info.js'(e, r) {
      ...
      function u(l, f, h, C) {
        var x = -1,
          b;
        for (d(this, 'space', C), t.call(this, l, f); ++x < o; ) ((b = n[x]), d(this, b, (h & a[b]) === a[b]));
      }
      function d(l, f, h) {
        h && (l[f] = h);
      }
  ...
  It = F({
    '../../node_modules/hastscript/node_modules/property-information/lib/xml.js'(e, r) {
      var t = ve();
      r.exports = t({space: 'xml', transform: a, properties: {xmlLang: null, xmlBase: null, xmlSpace: null}});
      function a(n, o) {
      ...
      function a(n, o) {
        for (var u = n || '', d = o || 'div', l = {}, f = 0, h, C, x; f < u.length; )
          ((t.lastIndex = f),
            ...
            h &&
              (C ? (C === '#' ? (l.id = h) : l.className ? l.className.push(h) : (l.className = [h])) : (d = h),
              (f += h.length)),
            x && ((C = x[0]), f++));
      ...
      function l(E, _, A) {
        ...
        function s(g, m) {
          var c = n(g, _),
            ...
            k;
          if (((c.tagName = i && d.call(i, v) ? i[v] : v), m && f(m, c) && (w.unshift(m), (m = null)), m))
            for (k in m) p(c.properties, k, m[k]);
          return (
            C(c.children, w),
            c.tagName === 'template' && ((c.content = {type: 'root', children: c.children}), (c.children = [])),
            c
          );
        }
        function p(g, m, c) {
      ...
      function h(E, _) {
        ...
        return E === 'input' || !A || typeof A != 'string'
          ...
          : typeof _.children == 'object' && 'length' in _.children
            ? !0
            : ((A = A.toLowerCase()),
              E === 'button' ? A !== 'menu' && A !== 'submit' && A !== 'reset' && A !== 'button' : 'value' in _);
      }
      function C(E, _) {
        var A, i;
        ...
        if (typeof _ != 'object' || !('type' in _)) throw new Error('Expected node, nodes, or string, got `' + _ + '`');
        E.push(_);
      }
      function x(E, _, A) {
        var i, s, p;
      ...
      function b(E, _, A) {
        ...
        return (
          E.number || E.positiveNumber
            ...
            : (E.boolean || E.overloadedBoolean) && typeof i == 'string' && (i === '' || a(A) === a(_)) && (i = !0),
          i
        );
      }
      function y(E) {
    ...
    '../../node_modules/refractor/node_modules/parse-entities/index.js'(e, r) {
      ...
      function Q(j, I) {
        var T = I.additional,
          ...
          V,
          q;
        for (typeof T == 'string' && (T = T.charCodeAt(0)), ye = be(), Y = pe ? ft : h, te--, Fe++; ++te < Fe; )
          if ((ne === b && (oe = gt[He] || 1), (ne = j.charCodeAt(te)), ne === E)) {
            if (
              ((D = j.charCodeAt(te + 1)),
              D === x || D === b || D === y || D === S || D === E || D === A || D !== D || (T && D === T))
            ) {
              ((le += f(ne)), oe++);
              continue;
            }
            for (
              ue = te + 1,
                ...
                q = ue,
                D === s
                  ? ((q = ++he), (D = j.charCodeAt(q)), D === p || D === g ? ((ee = w), (q = ++he)) : (ee = v))
                  : (ee = c),
                ge = '',
                se = '',
                P = '',
                    ...
                    : (ie || Y(H, V),
                      ...
                      M(R)
                        ...
                        : R in a
                          ...
                          : (($e = ''),
                            ce(R) && Y(W, V),
                            R > 65535 && ((R -= 65536), ($e += f((R >>> 10) | 55296)), (R = 56320 | (R & 1023))),
                            (R = $e + f(R))))
                  : ee !== c && Y(X, V)),
              R
                ? (Ge(),
        ...
        a = (function (n) {
            ...
            l = {
              ...
              highlightAllUnder: function (i, s, p) {
                ...
                (l.hooks.run('before-highlightall', g),
                  (g.elements = Array.prototype.slice.apply(g.container.querySelectorAll(g.selector))),
                  l.hooks.run('before-all-elements-highlight', g));
                for (var m = 0, c; (c = g.elements[m++]); ) l.highlightElement(c, s === !0, g.callback);
              },
              highlightElement: function (i, s, p) {
                ...
                if (s && n.Worker) {
                  ...
                  ((N.onmessage = function ($) {
                    ...
                    N.postMessage(JSON.stringify({language: v.language, code: v.code, immediateClose: !0})));
          ...
          f.stringify = function i(s, p) {
            ...
            (c && (Array.isArray(c) ? Array.prototype.push.apply(m.classes, c) : m.classes.push(c)),
              l.hooks.run('wrap', m));
            var w = '';
            for (var v in m.attributes) w += ' ' + v + '="' + (m.attributes[v] || '').replace(/"/g, '&quot;') + '"';
            return '<' + m.tag + ' class="' + m.classes.join(' ') + '"' + w + '>' + m.content + '</' + m.tag + '>';
          };
          function h(i, s, p, g) {
            i.lastIndex = s;
            var m = i.exec(p);
    ...
    '../../node_modules/refractor/core.js'(e, r) {
      ...
      function S(c, w) {
        var v = b.languages,
          ...
          z;
        w && ((k = {}), (k[c] = w));
        for (N in k) for ($ = k[N], $ = typeof $ == 'string' ? [$] : $, H = $.length, z = -1; ++z < H; ) v[$[z]] = v[N];
      }
      function E(c, w) {
        var v = u.highlight,
          k;
      ...
      function _(c) {
        if (typeof c != 'string') throw new Error('Expected `string` for `language`, got `' + c + '`');
...
function sn(e) {
  var r = e.length;
  if (r === 0 || r === 1) return e;
  if (r === 2) return [e[0], e[1], ''.concat(e[0], '.').concat(e[1]), ''.concat(e[1], '.').concat(e[0])];
  if (r === 3)
    return [
      e[0],
      e[1],
...
function pn(e, r) {
  ...
  return function (a) {
    return (
      (t += 1),
      a.map(function (n, o) {
        return qe({node: n, stylesheet: e, useInlineStyles: r, key: 'code-segment-'.concat(t, '-').concat(o)});
      })
    );
  };
}
function qe(e) {
  ...
  if (f) {
    ...
    if (!o) x = fe(fe({}, d), {}, {className: Xe(d.className)});
      ...
      x = fe(fe({}, d), {}, {className: Xe(S) || void 0, style: cn(d.className, Object.assign({}, d.style, n), t)});
    }
    var E = C(r.children);
...
function st(e, r, t) {
  var a = {display: 'inline-block', minWidth: Pn(t), paddingRight: '1em', textAlign: 'right', userSelect: 'none'},
...
function Ae(e) {
  ...
  if (((y.className = y.className ? [].concat(Te(y.className.trim().split(/\s+/)), Te(f)) : f), t && o)) {
    var S = st(a, t, n);
    r.unshift(it(t, S));
  }
  return (
...
`,
          ...
          if (v === 0) {
            var $ = h.slice(x + 1, b).concat(Ae({children: [N], className: p.properties.className})),
              H = E($, k);
            C.push(H);
...
function Wn(e) {
  ...
  if (ct(r)) {
    var o = qn(r, t);
    return t === 'text' ? {value: n, language: 'text'} : o ? r.highlight(t, a) : r.highlightAuto(a);
  }
  try {
...
function Kn(e, r) {
  return function (t) {
    ...
    if ((v ? (x.style = ae({whiteSpace: 'pre-wrap'}, x.style)) : (x.style = ae({whiteSpace: 'pre'}, x.style)), !L))
    ...
    var K = (a = (n = O.match(/\n/g)) === null || n === void 0 ? void 0 : n.length) !== null && a !== void 0 ? a : 0,
      U = s + K,
      re = Gn(T, c, N, E, A, s, U, m, v);
    return G.createElement(z, j, G.createElement(J, x, !A && Q, $({rows: re, stylesheet: l, useInlineStyles: y})));
  };
}
var Be = Z(an()),
  Me = Kn(Be.default, {});
...
var Vn = (0, rn.default)(2)((e) => Object.entries(e.code || {}).reduce((r, [t, a]) => ({...r, [`* .${t}`]: a}), {})),
  Jn = ht(),
  Qn = Ee.div(
  ...
  ea = ({children: e, className: r}) => G.createElement(xt, {horizontal: !0, vertical: !0, className: r}, e),
  ...
  pt = (e) => {
    let r = [...e.children],
      ...
      n = {
        ...t,
        children: [],
        properties: {...t.properties, 'data-line-number': a, style: {...t.properties.style, userSelect: 'auto'}},
      };
    return ((r[0] = n), {...e, children: r});
  },
  ra = ({rows: e, stylesheet: r, useInlineStyles: t}) =>
    e.map((a, n) => qe({node: pt(a), stylesheet: r, useInlineStyles: t, key: `code-segement${n}`})),
  ...
  dt = ({
    ...
    return G.createElement(
      ...
      t ? G.createElement(yt, {actionItems: [{title: x ? 'Copied' : 'Copy', onClick: y}]}) : null,
    );
  };
