        ...
        let s = le(),
          {
            ...
            if (r.length < 2)
              return { pathData: '', min: 0, max: 0, currentValue: 0, getY: () => a / 2 };
            let _ = 2,
              Se = o - _ * 2,
              j = a - _ * 2,
              U = Math.min(...r),
            ...
            return {
              pathData: r
                .map((F, Z) => `${Z === 0 ? 'M' : 'L'} ${fe(Z).toFixed(1)} ${q(F).toFixed(1)}`)
                .join(' '),
              min: U,
              max: J,
        ...
        return e.createElement(
          ...
          e.createElement(
            ...
            e.createElement(
              ...
              l === 0
                ...
                : e.createElement('span', null, ' \u{1F4A7}'),
            ),
          ),
          e.createElement(
            m,
            {
              label: 'Frame Jitter',
              tooltip:
                'Sudden spikes in frame time vs recent baseline. Indicates inconsistent rendering.',
            },
            e.createElement(
              p,
              { variant: b },
              s === 0 ? '\u2728 Smooth' : `\u26A1 ${String(s)} spikes`,
            ),
          ),
          e.createElement(
            m,
            ...
            e.createElement(
              ...
              e.createElement(
                'span',
                null,
                i >= 90 ? '\u{1F3AF} ' : i >= 70 ? '\u{1F4CA} ' : '\u{1F4C9} ',
              ),
          ...
          e.createElement(
            m,
            {
              label: 'Paint Jitter',
              tooltip:
                'Sudden spikes in paint time vs recent baseline. Indicates rendering inconsistency.',
            },
            e.createElement(
              p,
              { variant: _ },
              S === 0 ? '\u2728 None' : `\u{1F3A2} ${String(S)} spikes`,
            ),
          ),
        );
      }),
        ...
        return e.createElement(
          ...
          e.createElement(
            m,
            {
              ...
              tooltip:
                'Time from pointer move to next frame. High values indicate main thread contention.',
            },
        ...
        return e.createElement(
          ...
          e.createElement(
            m,
            {
              ...
              detail:
                o > 0 ? e.createElement(e.Fragment, null, 'longest: ', Math.round(o), 'ms') : null,
            },
            e.createElement(
              p,
              { variant: l },
          ...
          e.createElement(
            m,
            {
              label: 'Thrashing',
              tooltip:
                'Frame blocking >50ms near style writes. Indicates forced synchronous layout.',
            },
            e.createElement(
              p,
              { variant: i },
              c === 0 ? '\u2728 None' : `\u{1F504} ${String(c)} stalls`,
            ),
          ),
          e.createElement(
            m,
            {
              label: 'DOM Churn',
              tooltip:
                'DOM mutations per sample period. High values indicate excessive re-rendering.',
            },
            e.createElement(
              p,
              { variant: n },
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                p,
                { variant: 'neutral' },
                e.createElement('span', null, '\u26A0\uFE0F Not supported'),
              ),
            ),
          );
        ...
        return e.createElement(
          ...
          e.createElement(
            m,
            {
              label: 'Largest',
              tooltip:
                'Slowest element to render. Similar concept to LCP but for tracked elements.',
            },
            e.createElement(
              p,
              { variant: g(a, 100, 250) },
...
Render time: ${String(l.renderTime)}ms`,
              ...
              e.createElement(
                ...
                e.createElement(
                  'span',
                  null,
                  s === 0 ? '\u{1F947} ' : s === 1 ? '\u{1F948} ' : '\u{1F949} ',
                ),
          ...
          e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                p,
                { variant: i },
                r === 0 ? '\u{1F3AF} 0' : r > 0.25 ? `\u{1F4E6} ${z(r)}` : z(r),
              ),
            ),
            e.createElement(
              m,
              {
                ...
                tooltip:
                  'Layout reads after style writes force synchronous layout. Major perf killer during drag.',
              },
              e.createElement(
                p,
                { variant: n },
            ...
            e.createElement(
              m,
              {
                label: 'Input Jitter',
                tooltip:
                  'Unexpected input latency spikes causing visible hitches during interaction.',
              },
              e.createElement(
                p,
                { variant: E },
                s === 0 ? '\u2728 None' : `\u{1F635} ${String(s)} hitches`,
              ),
            ),
          )
        );
      ...
      qe = e.memo(function ({
        ...
        return e.createElement(
          ...
          e.createElement(
            ...
            e.createElement(
              m,
              { label: 'ID', tooltip: 'Profiler ID (React element ID or custom name)' },
              r,
            ),
            e.createElement(
              m,
            ...
            e.createElement(
              m,
              {
                ...
                detail:
                  c > 0 && u > 0 ? e.createElement(e.Fragment, null, u, ' total updates') : null,
              },
              c > 0
                ? e.createElement(
                    p,
            ...
            e.createElement(
              m,
              {
                label: 'P95 Duration',
                tooltip:
                  '95th percentile React update duration. Represents worst-case user experience.',
              },
              s > 0
                ? e.createElement(
                    p,
                    ...
                    e.createElement(
                      'span',
                      null,
                      s < d.REACT_P95_WARNING ? '\u{1F3AF} ' : '\u{1F422} ',
                    ),
            ...
            e.createElement(
              m,
              {
                label: 'Cascades',
                tooltip:
                  'Nested updates during commit phase. Often from setState in useLayoutEffect.',
              },
              e.createElement(
                p,
                { variant: T },
        ...
        return r === null
          ? e.createElement(
              ...
              e.createElement(
                m,
                { label: 'Heap' },
                e.createElement(R, null, 'Not available (Chrome only)'),
              ),
              e.createElement(
                m,
                { label: 'Paint Count', tooltip: 'Number of paint operations.' },
                s,
              ),
              e.createElement(
                m,
          ...
          : e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  ...
                  G(r),
                  'MB',
                  T && e.createElement(p, { variant: S }, ' (', T, ')'),
                ),
              ),
              e.createElement(
                m,
              ...
              e.createElement(
                ...
                e.createElement(
                  p,
                  { variant: n },
                  u > 0.01 ? `\u{1F5D1}\uFE0F ${He(u, 'MB/s')}` : '\u2728 Low',
                ),
              ),
              e.createElement(
                m,
                ...
                e.createElement(
                  ...
                  ' ',
                  i !== null
                    ? e.createElement(p, { variant: E }, i, ' layers')
                    : e.createElement('span', null, '\u2014'),
                ),
              ),
            );
      ...
      let u = () => r.status === 'connected',
        l = X({
          ...
          playFunctionThrewException: (E) => {
            o({
              type: 'STORY_ERROR',
              message: `Play function error: ${E.message || 'Unknown error'}`,
            });
          },
          storyArgsUpdated: () => {
          ...
          ? e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  'span',
                  null,
                  'Fix the error in your story to see performance metrics.',
                ),
              ),
            )
            ...
            ? e.createElement(
                ...
                e.createElement(
                  ...
                  e.createElement(
                    'span',
                    null,
                    'Docs mode renders stories in iframes which affects timing accuracy.',
                  ),
                ),
              )
            : o
    ...
    function rt({ active: t }) {
      return e.createElement(
        at,
        null,
        e.createElement(te, { active: t }, e.createElement(ot, { active: t })),
      );
    }
