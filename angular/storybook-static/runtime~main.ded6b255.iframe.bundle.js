(() => {
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (266 === chunkId ? 'public-notes-public-notes-stories' : chunkId) +
      '.' +
      {
        266: 'af114ea8',
        337: '460f1b69',
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute('data-webpack') == '@josh803316/angular-frontend:' + key
            ) {
              script = s;
              break;
            }
        ...
        (script ||
          ...
          script.setAttribute('data-webpack', '@josh803316/angular-frontend:' + key),
          (script.src = url)),
          (inProgress[url] = [done]));
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunk_josh803316_angular_frontend =
